...
with st.expander("PROJECT DETAILS"):
    ...
    st.write('I used _supervised learning_ to classify phishing and legitimate websites. '
             'I have used content-based approach and focus on html of the websites. '
             'I have used scikit-learn for the ML models.'
             )
    ...
    st.write('_https://github.com/prashantr0205/Phishing-website-detection-_')
    ...
    st.write('Features + URL + label')
    st.markdown('label is 1 for phishing | 0 for legitimate site')
    ...
    st.write('I used 6 different ML classifiers of scikit-learn and tested them implementing k-fold cross validation.'
