...
# 1 DEFINE A FUNCTION THAT OPENS AN HTML FILE AND RETURNS THE CONTENT
...
# 4 RUN STEP 1, 2, 3 FOR ALL HTML FILES AND CREATE A 2D ARRAY
folder = "mini_dataset"
...
# 5 CREATE A DATAFRAME USING 2D ARRAY
